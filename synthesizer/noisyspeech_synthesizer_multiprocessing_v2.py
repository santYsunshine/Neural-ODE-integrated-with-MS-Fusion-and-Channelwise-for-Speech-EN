...
def main_gen(params, filenum):
    ...
    while True:
        ...
        if noise_counter.value%len(params['noisefilenames']) == 0:
            print('noise_counter: ', noise_counter.value)
            print('repeat times: ', noise_counter.value//len(params['noisefilenames']))
...
def main_body():
    ...
    parser.add_argument('--cfg', default='noisyspeech_synthesizer_tt.cfg',
